      ...
      lastPreprocessMpy{ "1", "1", "1" }, lastPreprocessAdd{ "0", "0", "0" }
{
    ...
    comboGPUName->addItems({ "Radeon Instinct MI50", "Radeon Instinct MI25", "Radeon Instinct MI60", "Radeon GPU"});
    ...
    controlLayout->addWidget(labelCPUName, row, 3, 1, 1);
    comboCPUName = new QComboBox();
    comboCPUName->addItems({ "2nd Gen AMD EPYC", "AMD EPYC \"NAPLES\"", "AMD EPYC \"ROME\"", "AMD Ryzen 7", "AMD Ryzen 5", "AMX Ryzen 9", "Intel Xeon Gold"});
    controlLayout->addWidget(comboCPUName, row, 4, 1, 1);
    row++;
